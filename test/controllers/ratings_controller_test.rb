...
class RatingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rating" do
    assert_difference("Rating.count") do
      post ratings_url, params: { rating: { score: @rating.score, user_id: @rating.user_id } }
    end
  ...
  test "should update rating" do
    patch rating_url(@rating), params: { rating: { score: @rating.score, user_id: @rating.user_id } }
